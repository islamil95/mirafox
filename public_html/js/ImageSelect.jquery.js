...
var fn_template = '<img class="{class_name}" src="{url}" title="{title}" />'
var noimage_template = '<span class="{class_name}" title="{title}">'
 ...
 chosen: function(params) {
    ...
    this.each(function() {
        ...
        $this.on("chosen:showing_dropdown", function showing_dropdown(evt, chosen){
            ...
            var html_template = params.html_template ||
                                (rtl ? '{text}'+fn_template : /*fn_template+ //Убираем флаги с выпадашки */noimage_template + '{text}'+'</span>')
